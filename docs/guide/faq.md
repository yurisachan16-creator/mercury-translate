...
打开 Mercury Translate 弹窗，使用“恢复原文”。恢复操作只移除 Mercury Translate 插入的双语内容，不会把网页原本的文本写回其他位置。
...
2. Mercury Translate 中填写的地址与本机实际地址一致。
...
只填写在 Mercury Translate 设置页的服务配置中，不要放进网页、截图、Issue、聊天记录或 Git 仓库。若怀疑已经泄露，请立即在服务商控制台撤销并重新生成。
...
请在当前 GitHub 仓库的 Issues 页面中提供：

- 浏览器及版本；
- Mercury Translate 版本；
- 网页类型或可公开访问的链接；
- 复现步骤和预期结果；
- 控制台错误的脱敏截图或文字。
