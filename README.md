...
them. See the [privacy policy](./docs/privacy/index.md) for the exact data
boundaries.
...
with the versioned export/import flow; API keys are excluded by default.
...
Chrome Web Store listing materials live in
[`store-assets/chrome-web-store`](./store-assets/chrome-web-store). Public
