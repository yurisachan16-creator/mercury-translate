...
| OCR language-pack size numbers | Standard browser QA found the settings copy shows “约 MB” without a number; severity is low and unrelated to store safety. | Users cannot estimate the download size before choosing a pack. | Fix in the next product-polish contract or before public-search listing. |
