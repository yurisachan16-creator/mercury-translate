...
const distributionTarget = process.env.MERCURY_DISTRIBUTION_TARGET === 'chrome-web-store'
    ? 'chrome-web-store'
    : 'github';
...
const manifest = {
    ...
    ...(distributionTarget === 'github'
        ? {
            // The public half of the project key keeps the extension ID stable
            // for users updating GitHub Release builds. No signing secret is bundled.
            key: stableGithubReleaseKey,
        }
        : {}),
